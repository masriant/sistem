              ...
              <div class=" mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text" class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>"
                    id="alamat" name="alamat" value="<?= (old('alamat')) ? old('alamat') : $hotel['alamat'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text" class="form-control <?= ($validation->hasError('kota')) ? 'is-invalid' : ''; ?>"
                    id="kota" name="kota" value="<?= (old('kota')) ? old('kota') : $hotel['kota'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    name="marketing" value="<?= (old('marketing')) ? old('marketing') : $hotel['marketing'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="contact_marketing" name="contact_marketing"
                    value="<?= (old('contact_marketing')) ? old('contact_marketing') : $hotel['contact_marketing'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="status_marketing" name="status_marketing"
                    value="<?= (old('status_marketing')) ? old('status_marketing') : $hotel['status_marketing'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="date"
                    ...
                    name="checkout" value="<?= (old('checkout')) ? old('checkout') : $hotel['checkout'] ?>">
                  <div class="invalid-feedback">
            ...
            <div class="card-body">
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="number"
                    ...
                    id="bed_single" name="bed_single"
                    value="<?= (old('bed_single')) ? old('bed_single') : $hotel['bed_single'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="number"
                    ...
                    id="bed_double" name="bed_double"
                    value="<?= (old('bed_double')) ? old('bed_double') : $hotel['bed_double'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="number"
                    ...
                    name="bed_twin" value="<?= (old('bed_twin')) ? old('bed_twin') : $hotel['bed_twin'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="meeting_halfday" name="meeting_halfday"
                    value="<?= (old('meeting_halfday')) ? old('meeting_halfday') : $hotel['meeting_halfday'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="meeting_fullday" name="meeting_fullday"
                    value="<?= (old('meeting_fullday')) ? old('meeting_fullday') : $hotel['meeting_fullday'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="meeting_fullboard" name="meeting_fullboard"
                    value="<?= (old('meeting_fullboard')) ? old('meeting_fullboard') : $hotel['meeting_fullboard'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    id="bed_fullboard" name="bed_fullboard"
                    value="<?= (old('bed_fullboard')) ? old('bed_fullboard') : $hotel['bed_fullboard'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-md-8">
                  <input type="text"
                    ...
                    value="<?= (old('compliment')) ? old('compliment') : $hotel['compliment'] ?>">
                  <div class="invalid-feedback">
              ...
              <div class="form-check offset-md-3 col-md-8">
                ...
                <label class="form-check-label" for="gridCheck">
                  <!-- Check me out -->
                </label><button type="submit" class="btn btn-sm btn-primary">Ubah</button>
              </div>
            </div>
