        ...
        <table class="table table-striped table-sm caption-top">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $row['hotel']; ?></td>
              <td>
                <!-- <a href="</?= base_url(); ?>/hotel/userid/</?= $row['id']; ?>" target="_blank"
                  class="btn btn-sm btn-warning" role="button">Data User</a>
                <a href="</?= base_url(); ?>/hotel/detail/</?= $row['id']; ?>" target="_blank"
                  class="btn btn-sm btn-success" role="button">Sertifikat</a>
                <a href="</?= base_url(); ?>/hotel/kwitansi/</?= $row['id']; ?>" target="_blank"
                  class="btn btn-sm btn-danger" role="button">Kwitansi</a> -->
                <a href="<?= base_url(); ?>/hotel/<?= $row['slug']; ?>" class="btn btn-sm btn-info">
                  <i class="fas fa-edit"> Detail</a>
                <a href="<?= base_url(); ?>/hotel/sertifikat/<?= $row['slug']; ?>" class="btn btn-sm btn-success">
                  <i class="fas fa-edit"></i>Sertifikat</a>
                <a href="<?= base_url(); ?>/hotel/kwitansi/<?= $row['slug']; ?>" class="btn btn-sm btn-danger">
