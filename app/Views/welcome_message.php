  ...
  <header>
    ...
    <div class="menu">
      <ul>
        ...
        <li class="menu-item hidden"><a href="/lakip">Lakip</a>
        </li>
        <li class="menu-item hidden"><a href="/lakip/data">Admin</a></li>
        <li class="menu-item hidden"><a href="/lakip/about">About</a>
        </li>
      </ul>
    </div>
